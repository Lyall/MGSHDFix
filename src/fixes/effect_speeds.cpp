...
#define MGS2_CUTSCENE_FRAMESKIP_INLINE_HOOKS(X) \
    ...
    X(NewRipBubbleMan, "40 55 56 57 41 55 48 8D 6C 24", "MGS 2: Effect Speed Fix : user\\okajima\\effect2\\ripple_bubble.c -> Act() (NewRipBubbleMan_DEMO | NewRipBubbleMan)") \
    ...
    X(NewBubbleMany, "40 56 48 81 EC ?? ?? ?? ?? 48 8B 05 ?? ?? ?? ?? 48 33 C4 48 89 44 24 ?? 48 83 79 ?? 00 48 8B F1 75", "MGS 2: Effect Speed Fix : user\\okajima\\effect2\\bubble_many.c -> Act() (NewBubbleMany_Demo | NewBubbleMany | NewRaidenMaskBubbleDemo)") \
    X(RaidenMaskBubbleManager, "48 89 5C 24 18 57 48 83 EC 20 48 8B D9 48 8D 54 24 30 8B 49 58", "MGS 2: Effect Speed Fix : user\\okajima\\effect3\\raiden_mask_bubble.c -> Act() (periodic bubble-spawn manager)") \
